...
#define SIZEOF(x)               sizeof(x)/sizeof(x[0])                      ///< 数量
...
TCHAR *bus_type_text[]  = { _T("Unknown"),                                  ///< 总线类型
                            _T("SCSI"),
                            _T("ATAPI"),
                            _T("ATA"),
                            _T("IEEE1394"),
...
TCHAR *media_type_text[] ={ _T("Unknown"),                                  ///< 媒介
                            _T("F5_1Pt2_512"),
                            _T("F3_1Pt44_512"),
                            _T("F3_2Pt88_512"),
                            _T("F3_20Pt8_512"),
...
TCHAR *mft_file_text[]  = { _T("$MFT"),                                         ///< MFT数据
 ...
 *                              使用簇数量: 0100
 *                              结束标志: 00
 *\param[in]    data            得到簇流数据
 *\param[out]   head_un         簇开始
 *\return                       无
 */
 ...
 * -------------------------------------------------------------------
 *\param[in]    device          硬盘句柄
 *\param[in]    pos             数据在硬盘的位置
 *\param[in]    mft             文件表信息
 *\param[in]    mft_id          MFT的ID信息
 *\param[out]    count          数量
 *\return       0               成功
 */
 ...
 *\param[in]    parent          父句柄
 *\param[in]    pos             位置
 *\param[in]    cluster_sector_size     簇大小
 *\param[in]    cluster         簇信息
 *\param[in]    ntfs            是否为NTFS
 *\return                       无
 */
